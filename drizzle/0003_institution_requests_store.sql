CREATE TYPE "public"."connection_request_initiator" AS ENUM('lecturer', 'institution')
CREATE TYPE "public"."connection_request_status" AS ENUM('pending', 'approved', 'rejected', 'cancelled');
...
ALTER TABLE "institution_lecturer_requests" ADD CONSTRAINT "institution_lecturer_requests_lecturer_id_lecturers_id_fk" FOREIGN KEY ("lecturer_id") REFERENCES "public"."lecturers"("id") ON DELETE cascade ON UPDATE no action;
